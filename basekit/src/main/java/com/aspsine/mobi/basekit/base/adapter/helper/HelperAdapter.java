package com.aspsine.mobi.basekit.base.adapter.helper;


import android.content.Context;

import com.aspsine.mobi.basekit.base.adapter.base.BaseAdapter;
import com.aspsine.mobi.basekit.base.adapter.base.BaseViewHolder;
...
public abstract class HelperAdapter<T> extends BaseAdapter<T> implements DataHelper<T> {
    ...
    public <H extends BaseViewHolder> void convert(H viewHolder, int position, T t) {
        ...
        HelpConvert(helperViewHolder,position,t);
    }
    /*实现具体控件的获取和赋值等业务*/
